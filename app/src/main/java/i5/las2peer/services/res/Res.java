...
public class Res extends RESTService {
  ...
  @SwaggerDefinition(
      info = @Info(title = "171", version = "$Metadata_Version$",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-171/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response gettest() {
    ...
    if(res1_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity(result1.toJSONString()).build();
    }
    // res2
    ...
    if(res2_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_NOT_FOUND).entity(result2.toJSONString()).build();
    }
    return null;
  }
