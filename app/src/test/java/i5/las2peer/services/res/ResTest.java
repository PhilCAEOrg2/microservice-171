...
public class ResTest {
  ...
  /**
   * 
   * Test for the NewTestCase_ID674288 method.
   * 
   */
  @Test
  public void testNewTestCase_ID674288() {
...
""", "text/plain", "*/*", new HashMap<>(), new Object[0]);
      System.out.println("Result of request with id: 414382: " + result.getResponse().trim());
    
      Assert.assertEquals("[425642]", 200, result.getHttpCode());
